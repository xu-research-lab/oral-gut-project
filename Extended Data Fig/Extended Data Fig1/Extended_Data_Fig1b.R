...
load("../data/Extended Data Fig/Extended_Data_Fig1/Extended_Data_Fig1b.RData")
...
if (!is.null(plot_non_pma_abundance)) {
    ggsave("../results/Extended_Data_Fig1_b.pdf", plot = plot_non_pma_abundance, width = 7, height = 13)
}
